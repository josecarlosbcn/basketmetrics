...
let adv_stats = [{ stat: "assists_x_turnovers", order: "desc"}, { stat: "steals_x_turnovers", order: "desc"}];
 ...
 /**
  * To not show "incorrect" data due to the previous round of numbers. We calculate opp_fouls_cm and opp_fouls_rv of the opponent teams from 
  * fouls_cm of the team and fouls_rv of the team.
  * opp_fouls_cm = fouls_rv
  * opp_fouls_rv = fouls_cm
  * 
  * We receive these params
  * id_club: ID of the club
  * team_std_stats: Standard stats of the team
...
class TeamOppOther extends Component{
    constructor(props){
        super();
        this.props = props;
        this.state = {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className = "text-right" style = {{fontSize: 12 + "pt"}}>
                                    {String(this.props.team_opp_std_stats.assists_pp.toFixed(2)).replace(".", ",")}
                                </td>
                                <td className = "text-right" style = {{fontSize: 12 + "pt", 
                            ...
                            <tr>
                                ...
                                <td className = "text-right" style = {{fontSize: 12 + "pt"}}>
                                    {String(this.props.team_opp_std_stats.turnovers_pp.toFixed(2)).replace(".", ",")}
                                </td>
                                <td className = "text-right" style = {{fontSize: 12 + "pt", 
                            ...
                            <tr>
                                ...
                                <td className = "text-right" style = {{fontSize: 12 + "pt"}}>
                                    {String(this.props.team_opp_std_stats.steals_pp.toFixed(2)).replace(".", ",")}
                                </td>
                                <td className = "text-right" style = {{fontSize: 12 + "pt", 
                            ...
                            <tr>
                                ...
                                <td className = "text-right" style = {{fontSize: 12 + "pt"}}>
                                    {String(this.props.team_opp_adv_stats.assists_x_turnovers.toFixed(2)).replace(".", ",")}
                                </td>
                                <td className = "text-right" style = {{fontSize: 12 + "pt", 
                            ...
                            <tr>
                                ...
                                <td className = "text-right" style = {{fontSize: 12 + "pt"}}>
                                    {String(this.props.team_opp_adv_stats.steals_x_turnovers.toFixed(2)).replace(".", ",")}
                                </td>
                                <td className = "text-right" style = {{fontSize: 12 + "pt", 
                            ...
                            <tr>
                                ...
                                <td className = "text-right" style = {{fontSize: 12 + "pt"}}>
                                    {String(this.props.team_opp_std_stats.block_shots_pp.toFixed(2)).replace(".", ",")}
                                </td>
                                <td className = "text-right" style = {{fontSize: 12 + "pt", 
...
module.exports.TeamOppOther = TeamOppOther;