...
import { ResultContainerECU } from "./ResultContainerECU";

export default class ResultsECUContent extends Component{
    constructor(){
        super();
        this.state = {
            loaded: false,
    ...
    render(){
        const Header = () => 
            <h4 style={{ borderRadius: '0.25em', textAlign: 'center', color: '#FFFFFF', backgroundColor: '#091e36', padding: '0.5em' }}>
                EUROCUP / {this.state.descriptions.season} / {this.state.descriptions.competition} / Jornada {this.state.descriptions.gameday}
            </h4>        
        return(
            <div style = {{marginTop: 15 + 'px'}}>
            {
                (this.state.loaded) ?
                    <SearchGamedays 
                        id_league = {process.env.ID_LEAGUE_ECU}
...
//module.exports.ResultsECUContent = ResultsECUContent;