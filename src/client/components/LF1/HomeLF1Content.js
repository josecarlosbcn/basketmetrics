...
import {HOMELF1_NEXT_GAMES, SEASONS, TEAMS_SEASON_STD_STATS, TEAMS_SEASON_ADV_STATS, PLAYERS_STD_STATS_2, PLAYERS_SEASON_ADV_STATS_2 } from "../FEBCOM/Querys";
...
export default class HomeLF1Content extends Component{
    constructor(){
        super();
        this.state = {
            loaded: false,
    ...
    async getData(){
        ...
        let games = await getDataFromServer(process.env.URL_FEB_API, HOMELF1_NEXT_GAMES);
        params = [{"###id_season###": process.env.CURRENT_SEASON_LF1}];
        ...
        params = [{"###id_season###": process.env.CURRENT_SEASON_LF1}, {"###groups###": process.env.GROUPS_LF1}];
    ...
    render(){        
        var ng = this.state.loaded ? this.state.games.data.list_nextgamedaylf1 : [];
        ...
        let games = ng.map(game => {
            let url = "liga-femenina-1/previa/" + game.home_url_name + "-" + game.away_url_name + "/" + game.id; 
...
//module.exports.HomeLF1Content = HomeLF1Content;