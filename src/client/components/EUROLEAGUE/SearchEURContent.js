...
import { PLAYERS_CLUBS_FIBA } from "../FIBACOM/Querys";
import { PlayerSearcher } from "../COM/Searcher/FIBA/PlayerSearcher";
import { TeamSearcher } from "../COM/Searcher/FIBA/TeamSearcher";
import { Loading } from "../COM/Loading";


export default class SearchEURContent extends Component{
    constructor(){
        super();
        this.state = {
            loaded: false,
    ...
    async getData(){
        let player_season = await getDataFromServer(process.env.URL_FIBA_API, PLAYERS_CLUBS_FIBA);
        this.setState({
...
//module.exports.SearchEURContent = SearchEURContent;