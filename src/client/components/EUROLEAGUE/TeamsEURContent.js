...
export default class TeamsEURContent extends Component{
    constructor(){
        super();
        this.state = {
            loading: false,
    ...
    async getData(){
        ...
        params = [{"###param1###": process.env.ID_LEAGUE_EUR}];
        params = [{"###id_league###" : process.env.ID_LEAGUE_EUR}, {"###id_season###" : seasons.data.seasons[0].id}];
...
//module.exports.TeamsEURContent = TeamsEURContent;