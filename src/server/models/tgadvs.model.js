...
const FEBTeamGameAdvancedStats = FEBConnection.db.define("tbl009_team_adv_stats", {
        id_game: {
...
const FIBATeamGameAdvancedStats = FIBAConnection.db.define("tbl009_team_adv_stats", {
        id_game: {
            type: Sequelize.INTEGER,
            primaryKey: true,
            notNull: true
...
module.exports.FEBTeamGameAdvancedStats = FEBTeamGameAdvancedStats;
module.exports.FIBATeamGameAdvancedStats = FIBATeamGameAdvancedStats;